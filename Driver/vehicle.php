...
// Fetch Driver's Vehicles (or Fleet vehicle if assigned by transporter, but here we assume independent driver)
$vehicles = [];
...
<head>
    <meta charset="UTF-8">
    <title>Vehicle Details | Driver</title>
...
<div class="dashboard">
    ...
    <div class="content">
        <h2 style="margin-bottom: 20px;">🚛 Vehicle Details</h2>
        ...
        <div class="grid-layout">
            <div class="form-section">
                ...
                <form method="POST">
                    ...
                    <button type="submit" name="add_vehicle" class="btn-submit">Save Vehicle</button>
                </form>
            </div>
            ...
            <div class="table-section">
                ...
                <?php else: ?>
                <p>No vehicles registered. If you drive for a Transporter, your vehicles will be managed by them.</p>
                <?php endif; ?>
            </div>
        </div>
