...
<div class="dashboard">
    ...
    <div class="content">
        ...
        <div class="chat-container">
            <div class="chat-header">Customer / Transporter Chat</div>
            <div class="chat-messages">
                <div class="message received">Hi, have you reached the pickup location?</div>
                <div class="message sent">Almost there! Arriving in 15 minutes.</div>
            </div>
