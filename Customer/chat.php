...
<div class="dashboard">
    ...
    <div class="content">
        ...
        <div class="chat-container">
            <div class="chat-header">Driver / Support Chat</div>
            <div class="chat-messages">
                <div class="message received">Hello! Welcome to VAHAK Support. How can we help you regarding your shipment today?</div>
                <div class="message sent">Hi, I want to know if my assigned driver has started the trip.</div>
                <div class="message received">Yes, the driver is currently in transit. You can track the real-time status in the Track Shipment section.</div>
            </div>
